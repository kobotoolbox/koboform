...
public class ConditionWidget extends Composite implements ItemSelectionListener{
	...
	private void setupWidgets(){
		...
		operatorHyperlink = new OperatorHyperlink(OperatorHyperlink.EMPTY_VALUE,"",this);
		...
		funcHyperlink.setDataType(questionDef.getDataType());
	...
	public void setFocusOnFieldWidget()
	{
		fieldWidget.setFocus();
	}
	...
	public void onItemSelected(Object sender, Object item) {		
		if(sender == fieldWidget /*fieldHyperlink*/){
			...
			operatorHyperlink.setText(OperatorHyperlink.EMPTY_VALUE);
			valueWidget.setValue(ValueWidget.EMPTY_VALUE);
		}
	...
	public boolean setCondition(Condition condition){
		...
		questionDef = condition.getQuestion();
		if(questionDef == null)
			return false;
