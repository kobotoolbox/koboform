...
public class ModelConstants implements Serializable{
	...
	public static final String[] operatorStringMap = {"null", "Equal", "Greater",
		"Greater_Equal", "Less", "Less_Equal", "In_List",
		"Not_In_List", "is_null", "Between", "Not_Between",
		"Contains", "Not Contain", "Starts With", "Not Starts With", "Is Not Null",
		"Ends With", "Not Ends With", "In List Inclusive", "regex"};
}
