...
public class Toolbar extends Composite implements ILocaleListChangeListener{
	...
	public interface Images extends ClientBundle,FormRunnerView.Images {
		@Source("org/purc/purcforms/client/resources/newform.gif")
		ImageResource newform();
		@Source("org/purc/purcforms/client/resources/open.gif")
		ImageResource open();
		@Source("org/purc/purcforms/client/resources/save.gif")
		ImageResource save();
		@Source("org/purc/purcforms/client/resources/moveup.gif")
		ImageResource moveup();
		@Source("org/purc/purcforms/client/resources/movedown.gif")
		ImageResource movedown();
		@Source("org/purc/purcforms/client/resources/add.gif")
		ImageResource add();
		@Source("org/purc/purcforms/client/resources/addchild.gif")
		ImageResource addchild();
		@Source("org/purc/purcforms/client/resources/delete.gif")
		ImageResource delete();
		@Source("org/purc/purcforms/client/resources/justifyleft.gif")
		ImageResource justifyleft();
		@Source("org/purc/purcforms/client/resources/justifyright.gif")
		ImageResource justifyright();
		@Source("org/purc/purcforms/client/resources/cut.gif")
		ImageResource cut();
		@Source("org/purc/purcforms/client/resources/copy.gif")
		ImageResource copy();
		@Source("org/purc/purcforms/client/resources/paste.gif")
		ImageResource paste();
		@Source("org/purc/purcforms/client/resources/alignTop.gif")
		ImageResource alignTop();
		@Source("org/purc/purcforms/client/resources/alignBottom.gif")
		ImageResource alignBottom();
		@Source("org/purc/purcforms/client/resources/samewidth.gif")
		ImageResource samewidth();
		@Source("org/purc/purcforms/client/resources/sameheight.gif")
		ImageResource sameheight();
		@Source("org/purc/purcforms/client/resources/samesize.gif")
		ImageResource samesize();
		@Source("org/purc/purcforms/client/resources/undo.gif")
		ImageResource undo();
		@Source("org/purc/purcforms/client/resources/redo.gif")
		ImageResource redo();
		@Source("org/purc/purcforms/client/resources/refresh.gif")
	...
	private void setupToolbar(){
		...
		cbLanguages.addChangeHandler(new ChangeHandler(){
			public void onChange(ChangeEvent event){
				...
				Locale newLocale = new Locale(listBox.getValue(listBox.getSelectedIndex()),listBox.getItemText(listBox.getSelectedIndex()));
				if(!controller.changeLocale(newLocale))
...
/*		
		...
		btnAddNewChildItem.addClickHandler(new ClickHandler(){
			public void onClick(ClickEvent event){Etherton - Took this out because it's not the way we work controller.addNewChildItem();}});
